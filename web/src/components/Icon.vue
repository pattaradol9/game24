...
const PATHS = {
  ...
  bag: 'M6 8h12l-1 11.2a1.5 1.5 0 0 1-1.5 1.3h-7A1.5 1.5 0 0 1 7 19.2L6 8zM9 10.5V6a3 3 0 0 1 6 0v4.5',
  hourglass: 'M6.5 3h11M6.5 21h11M8 3v2c0 3 1.5 5 4 7s4 4 4 7v2M16 3v2c0 3-1.5 5-4 7s-4 4-4 7v2',
  sparkles: 'M11 4l1.7 4.6L17.3 10.3 12.7 12 11 16.6 9.3 12 4.7 10.3 9.3 8.6 11 4zM18.5 14.5l.9 2.4 2.4.9-2.4.9-.9 2.4-.9-2.4-2.4-.9 2.4-.9.9-2.4z',
}
